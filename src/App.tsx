...
const translations = {
  ...
  it: {
    newOnStore: "Novità su App Store",
  ...
  fr: {
    newOnStore: "Nouveau sur l'App Store",
  ...
  ar: {
    newOnStore: "جديد في متجر التطبيقات",
      ...
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-100">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button className="bg-slate-900 hover:bg-slate-800 text-white px-4 py-2 rounded-full text-sm font-medium transition-all flex items-center gap-2">
              <Download size={16} />
              ...
              <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
                <div className="space-y-8">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    <button className="px-8 py-4 bg-brand-600 hover:bg-brand-500 text-white rounded-2xl font-bold text-lg shadow-lg shadow-brand-500/30 transition-all hover:-translate-y-1">
                      {t.ctaStart}
                    </button>
                    <button className="px-8 py-4 bg-white text-slate-700 border border-slate-200 hover:border-slate-300 rounded-2xl font-bold text-lg transition-all">
                      {t.ctaMore}
                    </button>
                  </div>
                </div>
